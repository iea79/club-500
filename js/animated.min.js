...
function getCallOnScroll() {
    const pageScroll = new locomotive_scroll__WEBPACK_IMPORTED_MODULE_0__["default"]({
        el: container,
        smooth: true,
        smoothMobile: false,
        getDirection: true,
    ...
    function showCoursor(el, text) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to({}, 0.016, {
            repeat: -1,
            onRepeat: function() {
                posX += (mouseX - posX) / 9;
                posY += (mouseY - posY) / 9;

                gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].set(cursor, {
                    css: {
                        left: mouseX,
                        top: mouseY
                    }
